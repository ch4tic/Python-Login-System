...
global commands
commands = ['Change username', 'Reset password']
...
def signIn():
    ...
    try:
        ...
        file = open('D:/ch4tic/Programiranje/Python Programs/Login System/credentials2/' + usrLogin + ".txt", "r")
...
def usernameChange():
    ...
    if currentUsername == usrLogin:
        ...
        intro()
        os.system('cacls credentials2 /P everyone:f')
        file = open(r'D:/ch4tic/Programiranje/Python Programs/Login System/credentials2/' + newUsername + ".txt", "w")
        file.write(newUsername + ":" + pwdLogin)
        file.close()
        os.system('d:')
        os.chdir('credentials2')
        os.system('del ' + usrLogin + '.txt')
